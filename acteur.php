<?php
    ...
    try{
        ...
        $sth = $dbco->prepare("
            INSERT INTO acteur(civilact,nomprenact, agact, telact, adract,paynaissact,sitmatact,natiact,leecract,nivact,profesact,autrmetact,statprofact,Avenfact,nombenfact,comvilact,natact)
            VALUES(:civilite, :nometprenom, :age, :telephone, :adresse, :paysdenaissance, :situationmatrimoniale, :nationalite, :lireeecrire, :niveau, :profession, :autremetier, :quefaitevous, :enfantsacharge, :siouicombien, :communautevillageoise, :nature)");
        ...
        $sth->bindParam(':enfantsacharge',$Avenfact);
